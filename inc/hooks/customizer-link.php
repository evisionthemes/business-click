    ...
    <section class="container business-click-no-opton">
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            <?php
                ...
                printf(esc_html__('All Section are based on page/post. Enable each Section from customizer for %1$s slider: Home page->slider->Enable feature slider. likewise to other sections %2$s %3$s click here %4$s ','business-craft'), '<br />','<br />','<a class="btn" href="' . esc_url( admin_url( 'customize.php' ) ) . '">', '</a>');
                    ?>
