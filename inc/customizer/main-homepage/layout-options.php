...
$business_click_customizer_defaults['business-click-alternate-layout']              = 1;
...
$business_click_settings_controls['business-click-alternate-layout'] =
    array(
        'setting' =>     array(
            'default'              => $business_click_customizer_defaults['business-click-alternate-layout'],
        ),
        'control' => array(
            'label'                 =>  esc_html__( 'Alternate Archive Image Alignment', 'business-click' ),
            'section'               => 'business-click-layout-options',
            'type'                  => 'checkbox',
            'priority'              => 10,
        )
...
$business_click_settings_controls['business-click-single-post-image-align'] =
    ...
    // $business_click_settings_controls['business-click-number-of-words'] =
    // array(
    //     'setting' =>       array(
    //         'default'              =>   $business_click_customizer_defaults['business-click-number-of-words']
    //     ),
    //     'control' =>   array(
    //         'label'                 =>    esc_html__( 'Number Of Words For Excerpt', 'business-click' ),
    //         'description'           =>    esc_html__( 'This will controll the excerpt length on listing page', 'business-click' ),
    //         'section'               =>   'business-click-layout-options',
    //         'type'                  =>   'number',
